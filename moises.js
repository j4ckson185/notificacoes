...
// Reference to the "messages/moises" node in the Realtime Database
const userMessagesRef = ref(database, 'messages/moises');

// Listen for new messages added to "messages/moises"
