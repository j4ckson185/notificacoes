...
// Reference to the "messages/felipeaugusto" node in the Realtime Database
const userMessagesRef = ref(database, 'messages/felipeaugusto');

// Listen for new messages added to "messages/felipeaugusto"
