...
// Reference to the "messages/hionara" node in the Realtime Database
const userMessagesRef = ref(database, 'messages/hionara');

// Listen for new messages added to "messages/hionara"
